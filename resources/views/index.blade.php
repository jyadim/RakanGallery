                ...
                <div class="mt-4 flex justify-between items-center mb-3">
                    ...
                    <div class="flex items-center text-gray-700">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-gray-500 mr-1" fill="none"
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 10h.01M12 10h.01M16 10h.01M9 21h6a2 2 0 002-2v-1
                                a4 4 0 00-4-4H9a4 4 0 00-4 4v1a2 2 0 002 2zM15 5a3 3
                                0 11-6 0 3 3 0 016 0z" />
                        </svg>
                        <span class="text-sm font-medium">
                            {{ $comments->where('photo_id', $pict->id)->count() }} Comments
                        </span>
                    </div>
                </div>
